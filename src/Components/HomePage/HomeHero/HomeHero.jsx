    ...
    <>
      <div className="home-hero">
        ...
        <div className="hero-content">
          <h1 className="hero-title">REHYDRATE, REPLENISH, RECOVER WITH IVs</h1>

          <p className="hero-description">
          Medical-grade IV infusion therapy helping support hydration, nutrient balance, immunity, and physical recovery through targeted IV formulations.
          </p>
          ...
          <div className="hero-buttons">
            ...
            <a href="tel:+971503890119" target="_blank" rel="noopener noreferrer" className="btn secondary-btn">
